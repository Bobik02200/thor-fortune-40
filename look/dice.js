...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-1248b614');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-1248b614');}
...
function clearFlash(){dieView.classList.remove('rl-win-1248b614');dieView.classList.remove('rl-lose-1248b614');if(frameEl){frameEl.classList.remove('rl-win-1248b614');frameEl.classList.remove('rl-lose-1248b614');}}
function flashOutcome(won){clearFlash();if(won){dieView.classList.add('rl-win-1248b614');if(frameEl){frameEl.classList.add('rl-win-1248b614');}}else{dieView.classList.add('rl-lose-1248b614');if(frameEl){frameEl.classList.add('rl-lose-1248b614');}}
...
var brandEl=document.querySelector('.rl-brand-1248b614');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
